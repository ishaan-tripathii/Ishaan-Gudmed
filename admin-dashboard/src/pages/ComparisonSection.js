...
const ComparisonSection = () => {
  const defaultData = { title: "GudMed vs Other Technologies", items: [] };
  const { data, loading } = useDynamicData("/comparison", defaultData, "comparisonUpdated");
        ...
        <div className="overflow-x-hidden w-full">
          <table className="table-auto min-w-full bg-white rounded-lg text-sm sm:text-base">
            <thead className="bg-[#2E4168] text-white">
              <tr>
                <th className="border border-[#414c61] px-2 sm:px-4 py-2 sm:py-3 text-left font-bold">
                  Aspect
                </th>
                <th className="border border-[#414c61] px-2 sm:px-4 py-2 sm:py-3 text-left font-medium">
                  Other Technologies
                </th>
                <th className="border border-[#414c61] px-2 sm:px-4 py-2 sm:py-3 text-left font-bold text-2xl mx-auto">
                  GudMed
                </th>
              </tr>
            </thead>
